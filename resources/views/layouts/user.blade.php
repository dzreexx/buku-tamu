        ...
        <div class="flex h-16 items-center justify-between">
          ...
          <div class="hidden md:block">
                ...
                <div>
                    ...
                    <img class="h-8 w-8 rounded-full" src="{{ route('display.profile', auth()->user()->img_path) }}" alt="">
                  </button>
                </div>
                @elseif(Auth::user() && auth()->user()->is_admin === 1)
                <div>
                ...
                @endif
                <div id="menu-profile" class="hidden absolute z-10 mt-2 w-48 left-auto right-0 xl:right-auto origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                ...
                <div id="menu-profile-admin" class="hidden absolute z-10 mt-2 w-48 left-auto right-0 xl:right-auto origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
