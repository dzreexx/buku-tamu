...
<div class="flex h-screen flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      <img class="mx-auto h-40 w-auto" src="{{ asset('images/logotni.png') }}" alt="Your Company">
      <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Halaman Masuk Admin</h2>
    </div>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        Bukan Admin?
        <a href="#" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Masuk sebagai pengunjung</a>
      </p>
    </div>
  </div>
